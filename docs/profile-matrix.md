...
| Category | Service | default | all | gpu | ai | core | dev | development | dev-tools | proxy | networking | automation | media | monitoring | productivity |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| AI & ML | anythingllm |  | ✓ |  | ✓ |  |  |  |  |  |  |  |  |  |  |
| AI & ML | comfyui |  |  | ✓ |  |  |  |  |  |  |  |  |  |  |  |
| AI & ML | diffrhythm |  |  | ✓ |  |  |  |  |  |  |  |  |  |  |  |
...
- **Targeted groups**: chain profiles, e.g. `docker compose --profile dev --profile networking up -d` (Coder + Traefik) or `docker compose --profile productivity --profile ai up -d`.
- **Single-service helpers**: chain specific profiles when you only need a subset of services.
