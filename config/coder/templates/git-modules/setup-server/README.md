...
**NOTE:** This module only handles server setup. For preview link buttons in the Coder UI, use the separate `preview-link` module.
...
- Decoupled from preview link logic
...
module "agent" {
  source = "git::https://github.com/weekend-code-project/weekendstack.git//config/coder/templates/git-modules/coder-agent?ref=v0.1.1"
...
- No preview buttons created - use `preview-link` module for that
